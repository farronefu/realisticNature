...
| 素材 | 配布元 | 用途 | ライセンス |
|---|---|---|---|
| Tileable Moss Patches / sfdnqii / 4K | [Quixel Megascans / Fab](https://www.fab.com/listings/a9a94514-dfba-43cb-92bc-c550d79b8d5d) | 地形沿いの苔デカール100枚、岩の上面・斑点状の苔シェーダー | Fab Standard |
...
| Bark Debris 01 / 4K | [Poly Haven](https://polyhaven.com/a/bark_debris_01) | 4種類のスキャンした樹皮片を地形の傾きに沿って配置 | CC0 |
...
| Bark Brown 01 / 4K | [Poly Haven](https://polyhaven.com/a/bark_brown_01) | 細枝の粗さ。色と微細な凹凸は専用シェーダーで補正 | CC0 |
| Forest Slope / 4K HDR | [Poly Haven](https://polyhaven.com/a/forest_slope) | 環境照明 | CC0 |

地形、曲がる小道、細枝、カメラと配置は、この制作で構築しています。樹木・岩・シダ・樹皮片は配布されているスキャン素材などを使用しています。
...
CC0素材を過去のローカル取得から再利用した記録は `reused_assets.json`、復元スクリプトを実行して確認した全CC0素材のURL・サイズ・ハッシュは `download_manifest.json` にあります。
